							...
							<div class="table-responsive">
								<table class="table table-hover text-center">
									...
									<tbody>
                                        ...
                                        datosdocente_doctorado.noCedulaProfesionalDoctorado
                                    FROM
                                        datosdocentes
                                        INNER JOIN
                                        datosdocente_doctorado
                                        ON 
                                            datosdocentes.CURPDocente = datosdocente_doctorado.CURPDatosDocentes
                                        INNER JOIN
                                        doctorado
                                        ON 
									...
									while($registro = mysqli_fetch_assoc($resultado)){
										...
										<tr>
										  ...
										  <td>".$registro["noCedulaProfesionalDoctorado"]."</td>
											...
											<td><a href='funciones/eliminar-doctorado.php?CurpDelete=".$registro["CURPDatosDocentes"]."'><button class='btn btn-danger btn-raised btn-xs' type='button' onclick='return confirmarEliminar()'><i class='zmdi zmdi-delete'></i></button></a></td>
											</tr>
											";
										  }																										 
