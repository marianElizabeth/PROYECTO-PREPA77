	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-eye zmdi-hc-fw"></i> Información <small>Alumno</small></h1>
			</div>
								...
								<table class="table table-hover text-center">
									<thead>
										<tr>
											...
											<th class="text-center">El Alumno Trabaja</th>
											<th class="text-center">Tipo de Seguro</th>
											<th class="text-center">Número de Seguro Social</th>
											...
											<th class="text-center">C.C.T. Secundaria </th>
											<th class="text-center">Población Secundaria</th>
											<th class="text-center">Promedio de Secundaria</th>
											<th class="text-center">Nombre del Tutor</th>
											<th class="text-center">Nombre del Padre</th>
											<th class="text-center">Grado de Estudios del Padre</th>
											<th class="text-center">Ocupación del Padre</th>
											<th class="text-center">Teléfono Celular del Padre</th>
											<th class="text-center">CURP del Padre</th>
											<th class="text-center">Clave de Elector del Padre</th>
											<th class="text-center">Nombre de la Madre</th>
											<th class="text-center">Grado de Estudios de la Madre</th>
											<th class="text-center">Ocupación de la Madre</th>
											<th class="text-center">Teléfono Celular de la Madre</th>
											<th class="text-center">CURP de la Madre</th>
											<th class="text-center">Clave de Elector de la Madre</th>
											<th class="text-center">De Quien Depende Economicamente</th>
											<th class="text-center">Ocupación de Quien Depende</th>
