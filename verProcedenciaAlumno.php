								...
								<table class="table table-hover text-center">
									...
									<tbody>
										...
										while ($registro = mysqli_fetch_assoc($resultado) ){
										  ...
										  <td><a href='funciones/eliminar-procedenciaAlumno.php?MatriculaDelete=".$registro["matricula"]."'><button class='btn btn-danger btn-raised btn-xs' type='button' onclick='return confirmarEliminar()'><i class='zmdi zmdi-delete'></i></button></a></td>
										  </tr>
										  ";
										}																										 
