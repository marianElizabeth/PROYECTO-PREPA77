	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-refresh zmdi-hc-fw"></i>Preparacion profesional<small> Especialización</small></h1>
			</div>
                                            ...
                                            <div class="form-group label-floating">
													<label class="control-label" style="color: rgb(0, 0, 0); font-size: 120%;">Especialización en:</label>
													  <select class="form-control" style="color: rgba(0, 0, 0); font-size: 100%;" type="text"name="cmbEspecializacion">
														<option><?php echo $Especializacion['descripcionEspecializacion']?></option>
														<?php
																include("funciones/conexion.php");
												  ...
												  <div class="form-group">
													...
													<input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="date" name="fechaEgresoEspecializacion" value="<?php echo $Especializacion['fechaEgresoEspecializacion']?>">
												  </div>
										    <p class="text-center">
