...
<html lang="es">
<head>
	<title>Licenciatura Docente</title>
	<meta charset="UTF-8">
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Licenciatura <small>Docente</small></h1>
			</div>
			<p class="lead">Aquí podrá insertar y actualizar datos de su Licenciatura</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
