...
<html lang="es">
<head>
	<title>Ver Licenciatura Docente</title>
	<meta charset="UTF-8">
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-eye zmdi-hc-fw"></i>Licenciatura <small>Docente</small></h1>
			</div>
								...
								<table class="table table-hover text-center">
									<thead>
										<tr>
											...
											<th class="text-center">Escuela de Egresión</th>
									...
									<tbody>
										...
										$sentencia = "SELECT
                                            ...
                                            licenciatura.descripcionLicenciatura, 
                                            datosdocente_licenciatura.descripcionTituladoPasante, 
                                            datosdocente_licenciatura.noCedulaProfesional, 
                                            datosdocente_licenciatura.escuelaEgresionLicenciatura, 
                                            datosdocente_licenciatura.fechaEscuelaEgresion
                                        FROM
                                            datosdocentes
                                            INNER JOIN
                                            datosdocente_licenciatura
                                            ON 
                                                datosdocentes.CURPDocente = datosdocente_licenciatura.CURPDatosDocente
                                            INNER JOIN
                                            licenciatura
                                            ON 
                                                datosdocente_licenciatura.idLicenciatura = licenciatura.idLicenciatura
										";
									...
									while($registro = mysqli_fetch_assoc($resultado)){
										...
										<tr>
										  ...
										  <td>".$registro["descripcionLicenciatura"]."</td>
										  <td>".$registro["descripcionTituladoPasante"]."</td>
										  <td>".$registro["noCedulaProfesional"]."</td>
										  ...
										  <td>".$registro["fechaEscuelaEgresion"]."</td>
											...
											<td><a href='funciones/eliminar-licenciatura.php?CurpDelete=".$registro["CURPDocente"]."'><button class='btn btn-danger btn-raised btn-xs' type='button' onclick='return confirmarEliminar()'><i class='zmdi zmdi-delete'></i></button></a></td>
											</tr>
											";
										  }																										 
