										...
										<form action="funciones/actualizar-licenciaturadocente.php" method="POST">
											...
											<div class="form-group label-floating">
												...
												<div class="form-group label-floating">
												  ...
												  <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="text" name="txtEscEgresion" value="<?php echo $Licenciatura['escuelaEgresionLicenciatura']?>">
												</div>
												<div class="form-group">
												  <label class="control-label" style="color: rgb(0, 0, 0); font-size: 120%;">Fecha</label>
												  <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="date" name="fechaEgresion" value="<?php echo $Licenciatura['fechaEscuelaEgresion']?>">
												</div>
