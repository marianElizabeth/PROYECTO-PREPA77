	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Maestria <small>Docente</small></h1>
			</div>
										...
										<form action="funciones/guardar-maestriaDocente.php" method="POST">
                                            ...
                                            <div class="form-group label-floating">
												...
												<div class="form-group label-floating">
													...
													<input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;"type="text" name="txtNoCedulaMaestria" maxlength="12">
												  </div>
											<p class="text-center">
