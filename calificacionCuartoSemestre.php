...
<html lang="es">
<head>
	<title>Calificaciones Cuarto Semestre</title>
	<meta charset="UTF-8">
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-assignment-o zmdi-hc-fw"></i>Calificaciones <small>Cuarto Semestre</small></h1>
			</div>
			<p class="lead">Aquí podrá insertar todas las calificaciones del cuarto semestre</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
													...
													<table class="table table-hover text-center">
                                                        ...
                                                        <tbody>          
                                                            <tr class="text-center">    
                                                                <th class="text-center">Matemáticas IV</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaMateIV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaMateIV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaMateIV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalMateIV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalMateIV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalMateIV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                ...
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="date" name="txtFechaCalExtraMateIV_4" maxlength="2">
                                                                </td>                                           
                                                            </tr>
                                                            <tr class="text-center">    
                                                                <th class="text-center">Biología II</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaBiologiaII_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaBiologiaII_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaBiologiaII_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalBiologiaII_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalBiologiaII_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalBiologiaII_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            ...
                                                            <tr class="text-center">    
                                                                <th class="text-center">Física II</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaFisicaII_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaFisicaII_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaFisicaII_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                ...
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalFisicaII_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                ...
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalExtraFisicaII_4" value="0" maxlength="2">
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr class="text-center">    
                                                                <th class="text-center">Historia de México II</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaHMII_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaHMII_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaHMII_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalHMII_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalHMII_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalHMII_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            ...
                                                            <tr class="text-center">    
                                                                <th class="text-center">Inglés IV</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaInglesIV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaInglesIV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaInglesIV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalInglesIV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalInglesIV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalInglesIV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            ...
                                                            <tr class="text-center">    
                                                                <th class="text-center">Literatura II</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaLiteraturaII_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaLiteraturaII_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaLiteraturaII_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalLiteraturaII_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalLiteraturaII_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalLiteraturaII_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            ...
                                                            <tr class="text-center">    
                                                                <th class="text-center">Comunidades Virtuales</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaCV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaCV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaCV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalCV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalCV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalCV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            ...
                                                            <tr class="text-center">    
                                                                <th class="text-center">Mantenimiento y Redes de Cómputo</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaMRC_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaMRC_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaMRC_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalMRC_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalMRC_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalMRC_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            ...
                                                            <tr class="text-center">    
                                                                <th class="text-center">Actividades Físicas, Deportivas y Recreativas IV</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaAFDRIV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaAFDRIV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaAFDRIV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalAFDRIV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalAFDRIV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalAFDRIV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            ...
                                                            <tr class="text-center">    
                                                                <th class="text-center">Salud Integral del Adolescente IV</th>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaSIAIV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaSIAIV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtFaltaSIAIV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalSIAIV_1" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalSIAIV_2" maxlength="2">
                                                                </td>
                                                                <td>
                                                                    <input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;" type="number" name="txtCalSIAIV_3" maxlength="2">
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
