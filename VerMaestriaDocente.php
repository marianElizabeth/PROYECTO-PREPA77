									...
									while($registro = mysqli_fetch_assoc($resultado)){
										...
										<tr>
										  ...
										  <td>".$registro["noCedulaProfesionalMaestria"]."</td>
											...
											<td><a href='funciones/eliminar-maestria.php?CurpDelete=".$registro["CURPDatosDocente"]."'><button class='btn btn-danger btn-raised btn-xs' type='button' onclick='return confirmarEliminar()'><i class='zmdi zmdi-delete'></i></button></a></td>
											</tr>
											";
										  }																										 
