<?php
    ...
    $txtCalExtraPsicologiaII_4= $_POST['txtCalExtraPsicologiaII_3'];
    ...
    $calFilosofiaicacionFinal5   = ($txtCalPsicologiaII_3 + $txtCalPsicologiaII_2 + $txtCalPsicologiaII_1)/3;
    ...
    $calFilosofiaicacionFinal9  = ($txtCalPW_3 + $txtCalPW_2 + $txtCalPW_1)/3;
    $calFilosofiaicacionFinal10   = ($txtCalDD_3 + $txtCalDD_2 + $txtCalDD_1)/3;
    $calFilosofiaicacionFinal11  = ($txtCalAACIV_3 + $txtCalAACIV_2 + $txtCalAACIV_1)/3;
    $calFilosofiaicacionFinal12  = ($txtCalSIAVI_3 + $txtCalSIAVI_2 + $txtCalSIAVI_1)/3;
    ...
    $sentencia= "INSERT INTO `datosalumno-semestre6` VALUES 
        ...
        (DEFAULT,5,'$matricula',$txtFaltaPsicologiaII_1,$txtFaltaPsicologiaII_2,$txtFaltaPsicologiaII_3,$txtCalPsicologiaII_1,$txtCalPsicologiaII_2,$txtCalPsicologiaII_3,$txtCalExtraPsicologiaII_1,'$txtFechaCalExtraPsicologiaII_1',$txtCalExtraPsicologiaII_2,'$txtFechaCalExtraPsicologiaII_2',$txtCalExtraPsicologiaII_3,'$txtFechaCalExtraPsicologiaII_3',$txtCalExtraPsicologiaII_4,'$txtFechaCalExtraPsicologiaII_4',$calFilosofiaicacionFinal5),
        ...
        (DEFAULT,9,'$matricula',$txtFaltaPW_1,$txtFaltaPW_2,$txtFaltaPW_3,$txtCalPW_1,$txtCalPW_2,$txtCalPW_3,$txtCalExtraPW_1,'$txtFechaCalExtraPW_1',$txtCalExtraPW_2,'$txtFechaCalExtraPW_2',$txtCalExtraPW_3,'$txtFechaCalExtraPW_3',$txtCalExtraPW_4,'$txtFechaCalExtraPW_4',$calFilosofiaicacionFinal9),
        (DEFAULT,10,'$matricula',$txtFaltaDD_1,$txtFaltaDD_2,$txtFaltaDD_3,$txtCalDD_1,$txtCalDD_2,$txtCalDD_3,$txtCalExtraDD_1,'$txtFechaCalExtraDD_1',$txtCalExtraDD_2,'$txtFechaCalExtraDD_2',$txtCalExtraDD_3,'$txtFechaCalExtraDD_3',$txtCalExtraDD_4,'$txtFechaCalExtraDD_4',$calFilosofiaicacionFinal10),
        (DEFAULT,11,'$matricula',$txtFaltaAACIV_1,$txtFaltaAACIV_2,$txtFaltaAACIV_3,$txtCalAACIV_1,$txtCalAACIV_2,$txtCalAACIV_3,$txtCalExtraAACIV_1,'$txtFechaCalExtraAACIV_1',$txtCalExtraAACIV_2,'$txtFechaCalExtraAACIV_2',$txtCalExtraAACIV_3,'$txtFechaCalExtraAACIV_3',$txtCalExtraAACIV_4,'$txtFechaCalExtraAACIV_4',$calFilosofiaicacionFinal11),        
        (DEFAULT,12,'$matricula',$txtFaltaSIAVI_1,$txtFaltaSIAVI_2,$txtFaltaSIAVI_3,$txtCalSIAVI_1,$txtCalSIAVI_2,$txtCalSIAVI_3,$txtCalExtraSIAVI_1,'$txtFechaCalExtraSIAVI_1',$txtCalExtraSIAVI_2,'$txtFechaCalExtraSIAVI_2',$txtCalExtraSIAVI_3,'$txtFechaCalExtraSIAVI_3',$txtCalExtraSIAVI_4,'$txtFechaCalExtraSIAVI_4',$calFilosofiaicacionFinal12)
        ;";
