<?php
    ...
    $sentencia= "INSERT INTO datosalumno_semestre1 VALUES 
        ...
        (DEFAULT,4,'$matricula',$txtFaltaTallerI_1,$txtFaltaTallerI_2,$txtFaltaTallerI_3,$txtCalTallerI_1,$txtCalTallerI_2,$txtCalTallerI_3,$txtCalExtraTallerI_1,'$txtFechaCalExtraTallerI_1',$txtCalExtraTallerI_2,'$txtFechaCalExtraTallerI_2',$txtCalExtraTallerI_3,'$txtFechaCalExtraTallerI_3',$txtCalExtraTallerI_4,'$txtFechaCalExtraTallerI_4',$calificacionFinal4),
        (DEFAULT,5,'$matricula',$txtFaltaInglesI_1,$txtFaltaInglesI_2,$txtFaltaInglesI_3,$txtCalInglesI_1,$txtCalInglesI_2,$txtCalInglesI_3,$txtCalExtraInglesI_1,'$txtFechaCalExtraInglesI_1',$txtCalExtraInglesI_2,'$txtFechaCalExtraInglesI_2',$txtCalExtraInglesI_3,'$txtFechaCalExtraInglesI_3',$txtCalExtraInglesI_4,'$txtFechaCalExtraInglesI_4',$calificacionFinal5),
        (DEFAULT,6,'$matricula',$txtFaltaInfoI_1,$txtFaltaInfoI_2,$txtFaltaInfoI_3, $txtCalInfoI_1, $txtCalInfoI_2, $txtCalInfoI_3,$txtCalExtraInfoI_1,'$txtFechaCalExtraInfoI_1',$txtCalExtraInfoI_2,'$txtFechaCalExtraInfoI_2',$txtCalExtraInfoI_3,'$txtFechaCalExtraInfoI_3',$txtCalExtraInfoI_4,'$txtFechaCalExtraInfoI_4',$calificacionFinal6),
