<?php
    ...
    $idGrupo= $_POST['cmbGrupoAlum'];//22 en la BD(datosAlumno) -- en PHP(linea  185)
    ...
    $idAlumnoTrabaja= $_POST['cmbTrabajaAlum'];// 25  en la BD(datosAlumno) -- en PHP(linea 340)
    ...
    //$= $_POST['txtColoniaAlum'];//  en la BD(datosAlumno)
    //$= $_POST['cmbEstado'];//  en la BD(datosAlumno)
    //$= $_POST['cmbMunicipio'];//  en la BD(datosAlumno)
    //$= $_POST[''];
