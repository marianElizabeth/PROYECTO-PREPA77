...
<html lang="es">
<head>
	<title>Ver Especializacion Docente</title>
	<meta charset="UTF-8">
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-eye zmdi-hc-fw"></i>Especializacion <small>Docente</small></h1>
			</div>
							...
							<div class="table-responsive">
								<table class="table table-hover text-center">
									...
									<tbody>
										...
										$sentencia = "SELECT
                                        datosdocente_especializacion.CURPDatosDocentes, 
                                        especializacion.descripcionEspecializacion, 
                                        datosdocente_especializacion.fechaEgresoEspecializacion
                                    FROM
                                        datosdocentes
                                        INNER JOIN
                                        datosdocente_especializacion
                                        ON 
                                            datosdocentes.CURPDocente = datosdocente_especializacion.CURPDatosDocentes
                                        INNER JOIN
                                        especializacion
                                        ON 
                                            datosdocente_especializacion.idEspecializacion = especializacion.idEspecializacion
									...
									while($registro = mysqli_fetch_assoc($resultado)){
										...
										<tr>
										  ...
										  <td>".$registro["descripcionEspecializacion"]."</td>
										  <td>".$registro["fechaEgresoEspecializacion"]."</td>
										  
											<td><a href='actualizar-especializacion.php?CurpUpdate=".$registro["CURPDatosDocentes"]."' class='btn btn-success btn-raised btn-xs'><i class='zmdi zmdi-refresh'></i></a></td>
											<td><a href='funciones/eliminar-especializacion.php?CurpDelete=".$registro["CURPDatosDocentes"]."'><button class='btn btn-danger btn-raised btn-xs' type='button' onclick='return confirmarEliminar()'><i class='zmdi zmdi-delete'></i></button></a></td>
											</tr>
											";
										  }																										 
