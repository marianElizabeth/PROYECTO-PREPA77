	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-eye zmdi-hc-fw"></i>Padre <small>Alumno</small></h1>
			</div>
			<p class="lead">En esta sección puedes visualizar la información sobre los padres</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
								...
								<table class="table table-hover text-center">
									...
									<tbody>
										...
										while ($registro = mysqli_fetch_assoc($resultado) ){
										  ...
										  <td>".$registro["ape1Padre"]."</td>
										  <td>".$registro["ape2Padre"]."</td>
										  <td>".$registro["descripcionParentesco"]."</td>
										  <td>".$registro["descripcionOcupacion"]."</td>
										  <td>".$registro["telefonoCelularPadre"]."</td>
										  <td>".$registro["claveElectorPadre"]."</td>
										  ...
										  <td><a href='funciones/eliminar-padre.php?MatriculaDelete=".$registro["matricula"]."'><button class='btn btn-danger btn-raised btn-xs' type='button' onclick='return confirmarEliminar()'><i class='zmdi zmdi-delete'></i></button></a></td>
										  </tr>
										  ";
										}																										 
