	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-eye zmdi-hc-fw"></i>Dirección <small>Alumno</small></h1>
			</div>
			<p class="lead">En esta sección puedes visualizar la información sobre la dirección</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
								...
								<table class="table table-hover text-center">
									...
									<tbody>
										...
										while ($registro = mysqli_fetch_assoc($resultado) ){
										  ...
										  <td><a href='funciones/eliminar-direccionAlumno.php?MatriculaDelete=".$registro["matricula"]."'><button class='btn btn-danger btn-raised btn-xs' type='button' onclick='return confirmarEliminar()'><i class='zmdi zmdi-delete'></i></button></a></td>
										  </tr>
										  ";
										}																										 
