	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Doctorado <small>Docente</small></h1>
			</div>
			<p class="lead">Aquí podrá insertar y actualizar datos de su Doctorado</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
										<form action="funciones/guardar-doctoradoDocente.php" method="POST">
                                            ...
                                            <div class="form-group label-floating">
												...
												<div class="form-group label-floating">
													...
													<input class="form-control" style="color: rgb(0, 0, 0); font-size: 100%;"type="text" name="txtNCedulaDoctorado" maxlength="12">
												  </div>
											<p class="text-center">
